...
export const supabase = createClient<Database>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  ...
  global: {
    ...
    fetch: (url, options) => {
      // Increased timeout to 3 minutes for very large dataset operations
...
// Optimized fetchPaginated function for unlimited data access
export const fetchPaginated = async <T>(
  ...
  // Use a larger page size to reduce number of requests
  pageSize = 10000
): Promise<T[]> => {
  ...
  // Higher maxPages to support larger datasets
  const maxPages = 1000;
